...
class CarlaVehicle(object):
	...
	def reset(self,Norender):
		...
		#sixth scenario varying position zig zag
		...
		# prop_2_loc = carla.Transform(carla.Location(x=-36.970741, y=138.322726, z=1), carla.Rotation(pitch=0.119906, yaw=-0.817204, roll=0.000000))
		# prop_2 = self.world.spawn_actor(self.bp2, prop_2_loc)
		...
		prop_4_loc = carla.Transform(carla.Location(x=-38.970741, y=134.822726, z=1), carla.Rotation(yaw=0))
		prop_4 = self.world.spawn_actor(self.bp4, prop_4_loc)
		self.actor_list.append(prop_4)

		prop_5_loc = carla.Transform(carla.Location(x=-28.970741, y=135.322726, z=1), carla.Rotation(yaw=0))
		prop_5 = self.world.spawn_actor(self.bp4, prop_5_loc)
		self.actor_list.append(prop_5)

		# prop_6_loc = carla.Transform(carla.Location(x=-38.970741, y=130.322726, z=1), carla.Rotation(yaw=0+90))
		# prop_6 = self.world.spawn_actor(self.bp4, prop_6_loc)
		# self.actor_list.append(prop_6)

		prop_7_loc = carla.Transform(carla.Location(x=-15.970741, y=130.822726, z=1), carla.Rotation(yaw=0))
		prop_7 = self.world.spawn_actor(self.bp4, prop_7_loc)
		self.actor_list.append(prop_7)

		pedes1 = carla.Transform(carla.Location(x=-38.970741, y=125.322726, z=1), carla.Rotation(yaw=0+90))
		ped1 = self.world.spawn_actor(self.pedes, pedes1)
		self.actor_list.append(ped1)

		pedes2 = carla.Transform(carla.Location(x=-24.970741, y=125.322726, z=1), carla.Rotation(yaw=0+90))
		ped2 = self.world.spawn_actor(self.pedes, pedes2)
		self.actor_list.append(ped2)

		pedes3 = carla.Transform(carla.Location(x=-5.970741, y=122.322726, z=1), carla.Rotation(yaw=0+90))
		ped3 = self.world.spawn_actor(self.pedes, pedes3)
		self.actor_list.append(ped3)
		...
		control =  carla.VehicleControl()
		control.steer = 0
		control.throttle = 0.19
		prop_7.apply_control(control)
		...
		control.speed = 0.44
		jump = False
		ped2.apply_control(control)

		control = carla.WalkerControl()
		control.direction = carla.Vector3D(x=0,y=1,z=0)
		control.speed = 0.32
		jump = False
		ped3.apply_control(control)
